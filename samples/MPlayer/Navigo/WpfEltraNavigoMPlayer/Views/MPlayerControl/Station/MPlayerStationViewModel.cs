...
using EltraWpfCommon.Controls;
using EltraWpfCommon.Controls.Parameters;
...
{
    public class MPlayerStationViewModel : WpfToolViewModel
    {
            ...
            : base(parent)
        {
            ...
            _stationIdParameter = new WpfParameterEditViewModel(this, $"PARAM_Station_{stationIndex+1}_Id");   
            _stationVolumeScalingParameter = new WpfParameterEditViewModel(this, $"PARAM_Station_{stationIndex+1}_VolumeScaling");
        ...
        public ICommand ControlButtonCommand => new DelegateCommand(OnControlButtonPressed);
        
        public ICommand EditButtonCommand => new DelegateCommand(OnEditButtonPressed);
