...
{
    public class MPlayerControlViewModel : WpfToolViewModel
    {
        ...
        public ICommand TurnOffButtonCommand => new DelegateCommand(OnTurnOffButtonPressed);

        #endregion

        #region Events handling

        private void OnTurnOffButtonPressed()
        {
        ...
        public override void SetUp()
        {
            if (CanSetUp)
            {
                ...
                Image = new BitmapImage(new Uri(@$"pack://application:,,,/{assemblyName};component/Resources/music_32px.png", UriKind.Absolute));
