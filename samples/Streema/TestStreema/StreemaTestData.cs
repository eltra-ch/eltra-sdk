...
{
    class StreemaTestData
    {
        private readonly AgentConnector _connector;
        private readonly UserIdentity _identity;

        public StreemaTestData(AgentConnector connector, UserIdentity identity)
        {
        ...
        public async Task<EltraDevice> GetDevice(int nodeId)
        {
            ...
            if (signInResult)
            {
                var deviceIdentity = new UserIdentity() { Login = "streema@eltra.ch", Password = "1234" };
