...
namespace EltraCloudContracts.ObjectDictionary.Epos4.DeviceDescription.Profiles.Application.Parameters
{
    public class Range
    {
        private List<Epos4ValueEntry> _minValues;
        private List<Epos4ValueEntry> _maxValues;

        public List<Epos4ValueEntry> MinValues { get => _minValues ?? (_minValues = new List<Epos4ValueEntry>()); }
        public List<Epos4ValueEntry> MaxValues { get => _maxValues ?? (_maxValues = new List<Epos4ValueEntry>()); }
        ...
        public bool Parse(XmlNode node)
        {
            ...
            foreach (XmlNode childNode in node.ChildNodes)
            {
                ...
                {
                    var minValue = new Epos4ValueEntry();
