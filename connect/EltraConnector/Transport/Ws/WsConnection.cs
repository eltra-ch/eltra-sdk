...
namespace EltraConnector.Transport.Ws
{
    class WsConnection
    {
        ...
        public async Task<bool> Send(string typeName, string data)
        {
            bool result = false;
            ...
            try
            {
                ...
                wsMessage.ChannelName = ChannelName;
                wsMessage.TypeName = typeName;
                wsMessage.Data = data;
        ...
        public async Task<bool> Send<T>(T obj)
        {
            ...
            try
            {
                if(await Send(typeof(T).FullName, JsonConvert.SerializeObject(obj)))
                {
