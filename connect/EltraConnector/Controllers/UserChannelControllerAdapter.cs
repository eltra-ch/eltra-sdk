...
namespace EltraConnector.Controllers
{
    class UserChannelControllerAdapter : ChannelControllerAdapter
    {
        ...
        public UserChannelControllerAdapter(string url, UserIdentity identity, uint updateInterval, uint timeout)
            : base(url, identity, updateInterval, timeout)
        {   
        }

        public UserChannelControllerAdapter(string url, string uuid, UserIdentity identity, uint updateInterval, uint timeout)
